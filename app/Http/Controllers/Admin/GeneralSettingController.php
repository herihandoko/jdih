...
class GeneralSettingController extends Controller
{
    ...
    public function logo_update(Request $request)
    {
        ...
        // Unlink old photo
        unlink(public_path('storage/places/' . $request->current_photo));

        // Uploading new photo
        $ext = $request->file('logo')->extension();
        $final_name = 'logo' . '.' . $ext;
        Storage::putFileAs('public/places', $request->file('logo'), $final_name);
    ...
    public function bannerandroid_edit()
    {
        $general_setting = GeneralSetting::where('id', 1)->first();
        return view('admin.general_setting.bannerandroid', compact('general_setting'));
    }

    public function bannerandroid_update(Request $request)
    {
        $request->validate([
            'banner_android' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048'
        ]);
        ...
        // Uploading new photo
        $ext = $request->file('banner_android')->extension();
        $final_name = 'banner_android' . '.' . $ext;
        Storage::putFileAs('public/places', $request->file('banner_android'), $final_name);
        //        $request->file('logo')->move(public_path('uploads/'), $final_name);

        $data['banner_android'] = $final_name;
    ...
    public function favicon_update(Request $request)
    {
        ...
        Storage::putFileAs('public/places', $request->file('favicon'), $final_name);
    ...
    public function loginbg_update(Request $request)
    {
        ...
        Storage::putFileAs('public/places', $request->file('login_bg'), $final_name);
    ...
    public function preloader_update(Request $request)
    {
        if ($request->file('preloader_photo')) {
            ...
            Storage::putFileAs('public/places', $request->file('preloader_photo'), $final_name);
    ...
    public function banner_update(Request $request)
    {
        ...
        if ($request->hasFile('banner_about')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_about'), $final_name);
        ...
        if ($request->hasFile('banner_service')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_service'), $final_name);
        ...
        if ($request->hasFile('banner_service_detail')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_service_detail'), $final_name);
        ...
        if ($request->hasFile('banner_blog')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_blog'), $final_name);
        ...
        if ($request->hasFile('banner_blog_detail')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_blog_detail'), $final_name);
        ...
        if ($request->hasFile('banner_category')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_category'), $final_name);
        ...
        if ($request->hasFile('banner_project')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_project'), $final_name);
        ...
        if ($request->hasFile('banner_project_detail')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_project_detail'), $final_name);
        ...
        if ($request->hasFile('banner_team_member')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_team_member'), $final_name);
        ...
        if ($request->hasFile('banner_team_member_detail')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_team_member_detail'), $final_name);
        ...
        if ($request->hasFile('banner_photo_gallery')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_photo_gallery'), $final_name);
        ...
        if ($request->hasFile('banner_video_gallery')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_video_gallery'), $final_name);
        ...
        if ($request->hasFile('banner_faq')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_faq'), $final_name);
        ...
        if ($request->hasFile('banner_product')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_product'), $final_name);
        ...
        if ($request->hasFile('banner_product_detail')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_product_detail'), $final_name);
        ...
        if ($request->hasFile('banner_contact')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_contact'), $final_name);
        ...
        if ($request->hasFile('banner_search')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_search'), $final_name);
        ...
        if ($request->hasFile('banner_cart')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_cart'), $final_name);
        ...
        if ($request->hasFile('banner_checkout')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_checkout'), $final_name);
        ...
        if ($request->hasFile('banner_login')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_login'), $final_name);
        ...
        if ($request->hasFile('banner_registration')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_registration'), $final_name);
        ...
        if ($request->hasFile('banner_forget_password')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_forget_password'), $final_name);
        ...
        if ($request->hasFile('banner_customer_panel')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_customer_panel'), $final_name);
        ...
        if ($request->hasFile('banner_career')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_career'), $final_name);
        ...
        if ($request->hasFile('banner_job')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_job'), $final_name);
        ...
        if ($request->hasFile('banner_job_application')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_job_application'), $final_name);
        ...
        if ($request->hasFile('banner_term')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_term'), $final_name);
        ...
        if ($request->hasFile('banner_privacy')) {
            ...
            Storage::putFileAs('public/places', $request->file('banner_privacy'), $final_name);
