<div class="sidebar">
    <div>
        <div class="widget feature-mono">
            <form action="{{ url('search-artikel-hukum') }}" method="post">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <a class="btn btn-primary btn-block" style="background-color:#11D694; border-color: #11D694;" href="{{ url('artikel-hukum') }}">
