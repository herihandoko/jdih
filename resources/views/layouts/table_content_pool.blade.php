<table class="table table-fixed table-condensed td" width="100%" cellspacing="0" style="font-size: small;">
    ...
    @if($produkCat->category_name == 'Artikel Hukum')
        <tbody>
            <tr>
    ...
    @elseif($produkCat->category_name == 'Monografi Hukum')
        <tbody>
            <tr>
                <td>{{ translateText('Tipe Dokumen') }}</td>
                <td>:</td>
    ...
    @elseif($produkCat->category_name == 'Putusan Pengadilan')
        <tbody>
            <tr>
                <td>Tipe Dokumen</td>
                <td>:</td>
                                ...
                                @if($catatanStatus[$i]->jenis_status == $status)
                                    <ul>
                                        @if($routes == 'front.pool.detail')
                                            ...
                                            @endphp
                                            <form id="detailForm" action="{{ route('front.pool.detail', ['menuslug' => $menu->slug, 'slug' => $catatanStatus[$i]->slug]) }}" method="POST" style="display: inline;">
                                                @csrf
