...
<div class="page-banner">
    <div class="container">
        <h1>{{ translateText('Indeks Hukum IRH') }}</h1>
    </div>
</div>
...
<div class="page-content mt_30">
    <div class="container-jdihcontent">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <table id="tableFrontIrh" class="table table-fixed table-striped table-hover" style="width:100%" cellspacing="0" style="font-size: small;">
                        <thead>
                            <tr>
                                <th>Judul</th>
                        ...
                        <tbody>
                            @foreach($contentList as $row)
                                <tr>
                                    <td style="vertical-align: middle;">{{ $row->irh_name }}</td>
                                    <td data-label="Tahun" style="text-align: center; vertical-align: middle;">{{ $row->irh_year }}</td>
                                    <td data-label="Nilai" style="text-align: center; vertical-align: middle;">{{ $row->irh_score }}</td>
                                    <td data-label="File" style="text-align: center; vertical-align: middle;">
                                        @if($row->irh_file && $row->irh_file_view == 0)
