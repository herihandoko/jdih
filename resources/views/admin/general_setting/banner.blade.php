                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_about) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                            <div>
                                <input type="file" name="banner_about" accept=".jpeg, .png, .jpg, .gif">
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_service) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_service_detail) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_blog) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_blog_detail) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_category) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_project) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_project_detail) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_team_member) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_team_member_detail) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_photo_gallery) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_video_gallery) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_faq) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_product) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_product_detail) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_contact) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_search) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_cart) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_checkout) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_login) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_registration) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_forget_password) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_customer_panel) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_career) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_job) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_job_application) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_term) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
                ...
                <div class="card-body">
                    <form action="{{ url('admin/setting/general/banner/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Existing Banner</label>
                            <div>
                                <img src="{{ asset('storage/places/'.$general_setting->banner_privacy) }}" alt="" class="w_200">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Change Banner</label>
