                ...
                <table class="table table-fixed table-condensed table-responsive table-striped" id="dataTable" width="100%" cellspacing="0" style="font-size: small;">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><input type="text" placeholder="Cari Urusan Pemerintahan" class="form-control form-control-sm column-filter" data-column="2" /></th>
                            <th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: auto;">{{ $row->up_code }}</td>
                            <td style="width: auto;">{{ $row->up_name }}</td>
                            <td style="text-align: center; width: auto;">@if($row->up_active == 1) <font class="btn-success btn-sm" style="font-size: small;">{{ 'Ya' }}</font> @else <font class="btn-danger btn-sm" style="font-size: small;">{{ 'Tidak' }}</font> @endif</td>
