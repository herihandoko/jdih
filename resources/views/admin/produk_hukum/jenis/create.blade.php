...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Tambah Jenis Peraturan</h1>

    <form action="{{ route('admin.produk_hukum.jenis.store') }}" method="post">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Tambah Jenis Peraturan</h6>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="type_name" class="form-control" value="{{ old('type_name') }}" autofocus>
                </div>
