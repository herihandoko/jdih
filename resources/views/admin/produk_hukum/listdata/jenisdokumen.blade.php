...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Pilih Tipe Dokumen</h1>
    
    <form action="{{ route('admin.produk_hukum.listdata.postjenisdokumen') }}" method="post" autocomplete="off">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Pilih Tipe Dokumen</h6>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-block btn-sm btn-success">
                    Selanjutnya&nbsp;<i class="fas fa-forward"></i>
                </button>
            </div>
        </div>
    </form>
