...
@section('admin_content')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.peraturan_select').each(function(){
                var categoryId = $(this).attr('id').split('_').pop();
                var selectedValue = $(this).val();
                
                $('#peraturan_id_'+categoryId+'').select2();
                $('#diubah_id_'+categoryId+'').select2();
                $('#mengubah_id_'+categoryId+'').select2();
                $('#dicabut_id_'+categoryId+'').select2();
                $('#mencabut_id_'+categoryId+'').select2();
            });
        });
                ...
                ajax:{
                    ...
                    data: (params) => {
                        var query = {
                            search: params.term,
                            page: params.page || 1,
                            catId : "{{ $produkHukumList->produk_hukum_categories_id }}",
                        };
        ...
        var y = {{ count($produkPeraturanTerkait) }};
...
//                );
        ...
        var z = {{ count($produkDokumenTerkait) }};
