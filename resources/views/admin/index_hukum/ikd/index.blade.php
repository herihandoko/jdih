...
<style>
    ...
    <h1 class="h3 mb-3 text-gray-800">Indeks IKD</h1>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 mt-2 font-weight-bold text-primary">List Indeks IKD</h6>
            <div class="float-right d-inline">
                <a href="{{ route('admin.index_hukum.ikd.create') }}" class="btn btn-primary btn-sm">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-fixed table-condensed table-responsive table-striped" id="dataTable" width="100%" cellspacing="0" style="font-size: small;">
                    ...
                    <tbody>
                        @foreach($indexIkd as $row)
                        <tr>
                            <td style="text-align: center; width: 2%; vertical-align: middle;">
                                {{ $loop->iteration }}
                            </td>
                            <td style="width: 50%; vertical-align: middle;">{{ $row->ikd_name }}</td>
                            <td style="width: 15%; text-align: center; vertical-align: middle;">{{ $row->ikd_year }}</td>
                            <td style="width: 15%; text-align: center; vertical-align: middle;">{{ $row->ikd_score }}</td>
                            ...
                            <td style="text-align: center; width: auto;">
                                @php $ikdID = Crypt::encrypt($row->id); @endphp
                                <a href="{{ URL::to('admin/index-hukum/ikd/edit/'.$ikdID) }}" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i>
                                </a>
                                
                                <a href="#" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#confirm-delete" class="btn btn-danger btn-sm" data-href="{{ URL::to('admin/index-hukum/ikd/delete/'.$row->id) }}">
