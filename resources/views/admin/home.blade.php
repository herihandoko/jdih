...
@section('admin_content')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Peraturan Tahun Ini</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div style="height: 400%" id="pie_basic"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Peraturan Tahun Lalu</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="row">
                        <label for="" class="my-2 mr-2">
                            Tahun:
                        </label>
                        <select style="width: auto;" class="form-control my-0 py-1 red-border selectpicker years" data-live-search="true" id="dropdowntahun" name="tahun">
                ...
                <div class="card-footer" style="height: 365px; background-color: transparent !important;">
                    <div style="height: 100%" id="bar_basic"></div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        var dataVal = [
                @foreach ($peraturanCurrentYear as $row)
                    { value: {{ $row->total_peraturan }}, name: '{{ $row->nama_peraturan }}' },
                @endforeach
                ];
    ...
    <script type="text/javascript">
        ...
        $("select.years").change(function() {
            ...
            var changeYears = $(this).children("option:selected").val();
            var dataNamaPeraturan = [];
            var dataTotalPeraturan = [];
            
            $.ajax({
                url: '/admin/dashboard/getyear/{years}',
                type: 'get',
                data: {
                    years: changeYears
                },
                ...
                success: function(response) {
                    for(var i = 0; i < response.length; i++) {
                        dataNamaPeraturan.push(response[i].nama_peraturan);
                        dataTotalPeraturan.push(response[i].total_peraturan);
                    }
                    barChart.hideLoading();
                    barChart.setOption({
                        yAxis: {
                            data: dataNamaPeraturan
                        },
                        series: [{
                                name: 'Total:',
                                data: dataTotalPeraturan
                        }]
                    });
                },
