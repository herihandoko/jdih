        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="slider_button_text" class="form-control" value="{{ old('slider_button_text') }}" autofocus required>
                </div>
                <div class="form-group">
                    <label for="">Slider Button URL *</label>
                    <input type="text" name="slider_button_url" class="form-control" value="{{ old('slider_button_url') }}" autofocus required>
                </div>
                <div class="form-group">
